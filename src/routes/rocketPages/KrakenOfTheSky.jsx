...
const KrakenOfTheSky = () => {
  return (
    <>
      <RocketPageOutline title="KRAKEN OF THE SKY" img={kotsUpright} altText="Kraken of the sky drawing">
        <Content title="Overview">
          Kraken of the Sky (KotS) is a hybrid rocket developed for participation in the
          2022 Spaceport America Cup (SAC), 30,000 ft SRAD (Student Researched And Designed)

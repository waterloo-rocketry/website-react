    ...
    <>
      ...
      <Container fluid>
        <Row lg={2} md={2} sm={1} xs={1}>
          <Col
            className="my-5 mx-md-0 mx-sm-2 text-center"
          ...
          <Col
            className="my-lg-5 my-md-5 mx-md-0 mx-sm-4 justify-content-center"
          ...
          >
            ...
            <Content title="ACADEMIC ADVISOR">
              <p className="content-text">
                ...
                <br />
                <a href="mailto:ajbmilne@uwaterloo.ca">ajbmilne@uwaterloo.ca</a>
              </p>
            </Content>
          </Col>
        </Row>
          ...
          <Col className="my-4 text-center">
            <a href="https://www.facebook.com/WaterlooRocketry/">
              <img
                alt="Facebook"
                className={styles.fb}
                src="https://duo.com/assets/img/customerlogos/tech-facebook.png"
              />
            </a>
          </Col>
          <Col className="my-4 text-center">
          ...
          <Col className="my-4 text-center">
            <a href="https://www.youtube.com/user/uwrocketry">
              <img
                ...
                className={styles.yt}
                /* eslint-disable-next-line max-len */
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTGb_-wlzPBl2X6V7SXwIwRVMGUi0ciOp5apm8IltXM_lqOfkUM"
              />
            </a>
          </Col>
        </Row>

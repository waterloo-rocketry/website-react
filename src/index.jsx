        ...
        <BrowserRouter>
            ...
            <Routes>
                ...
                <Route
                    ...
                    element={
                        <Redirect
                            url={`${window.location.origin}/pdfs/sponsorship_package.pdf`}
                        />
                    }
                />
                <Route
                ...
                <Route
                    ...
                    path="rockets/lots"
                    element={
                        <Page title="Leviathan Of The Sky">
                            <LeviathanOfTheSky />
                        </Page>
                    }
                />
                ...
                <Route
                    ...
                    path="rockets/uxo"
                    element={
                        <Page title="Unexploded Ordnance">
                            <UnexplodedOrdnance />
                        </Page>
                    }
                />
